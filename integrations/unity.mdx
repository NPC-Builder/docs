...
![unity-1](/integrations/media/unity-1.png)
...
Fill <code>Game ID</code>, <code>World ID</code>, and <code>character_id</code>—all visible in the dashboard context tree.
![unity-2](/integrations/media/unity-2.png)
