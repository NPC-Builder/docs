...
<Columns cols={2}>
  ...
  <Card title="Character" icon="user">
    Individual NPC tied to a specific location.
  </Card>
</Columns>
...
<li><code>politicalStability</code> – enum:<br/>
...
<li><code>age</code> – enum: <em>infant • child • teenager • youngAdult • adult • middleAged • elderly</em></li>
...
<li><code>items</code> – array of<br/>
  <code>{ itemName, unit, value }</code> (each max 25 chars)</li>
<li><code>quests</code> – array of<br/>
